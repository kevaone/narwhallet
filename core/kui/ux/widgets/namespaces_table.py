...
class _namespaces_table(QTableWidget):
    ...
    def time_to_str(self, time):
        _date = datetime.datetime.fromtimestamp(time)
    ...
    def _add_namespace(self, namespace_data: dict):
        ...
        _date = QTableWidgetItem(self.time_to_str(namespace_data['date']), 0)
        ...
        self.setItem(_r, 2, QTableWidgetItem(_wallet))
        self.setItem(_r, 3, QTableWidgetItem(_shortcode))
        self.setItem(_r, 4, QTableWidgetItem(_keys))
        self.setItem(_r, 5, QTableWidgetItem(_namespaceid))
        self.setItem(_r, 6, QTableWidgetItem(_address))
