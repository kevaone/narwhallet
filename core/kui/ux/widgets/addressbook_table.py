...
class _address_book_table(QTableWidget):
    ...
    def _add_bookaddress(self, book_address: dict):
        ...
        self.setItem(_r, 1, QTableWidgetItem(_coin))
        self.setItem(_r, 2, QTableWidgetItem(_name))
        self.setItem(_r, 3, QTableWidgetItem(_address))
        self.setItem(_r, 4, QTableWidgetItem(_sent))
        self.setItem(_r, 5, QTableWidgetItem(_received))
        self.setItem(_r, 6, QTableWidgetItem(_label))
