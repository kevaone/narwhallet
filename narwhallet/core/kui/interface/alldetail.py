...
class AllDetailScreen(Screen):
    ...
    def __init__(self, **kwargs):
        super(AllDetailScreen, self).__init__(**kwargs)
    ...
    def populate(self, namespaceid):
        ...
        self.owner = str(_ns.address)
        self.creator = str(_ns.creator)
        ...
        self.manager.current = 'alldetail_screen'
