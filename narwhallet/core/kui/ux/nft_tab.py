...
class Ui_NFTTab(QObject):
    def setupUi(self):
        ...
        self.frame_1a = QFrame(splitter_tables)
        self.frame_1b = QFrame(splitter_tables)
        self.frame_2 = QFrame(self.tabNFT)
        self.frame_3 = QFrame(self.tabNFT)
        self.tbl_auctions = _auctions_table('nft_auctions', self.frame_1a)
        self.tbl_bids = _bids_table('nft_bids', self.frame_1b)
