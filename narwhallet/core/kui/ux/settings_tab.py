...
class Ui_SettingsTab(QObject):
    def setupUi(self):
        ...
        self.s_a_df.setEnabled(False)
        self.s_t_df_l.setEnabled(False)
        self.s_t_df_e.setEnabled(False)
        ...
        self.auto_lock_hl.addItem(QSpacerItem(5, 5, _sp_minexp, _sp_minexp))
