...
source.include_exts = py,png,jpg,kv,json,addressbook,favorites,txt,otf,mymedia
...
requirements = python3,crcmod,pycryptodome==3.4.6,ecdsa,pynacl,scalecodec,qrcode~=6.1,kivy,base58,certifi,cryptography
